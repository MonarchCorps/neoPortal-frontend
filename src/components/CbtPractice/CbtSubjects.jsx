    ...
    return (
        <>
            ...
            <div className='border-y border-solid border-y-gray-200 py-5 mt-4'>
                <Link to='exam-config' onClick={scrollTop} className='border-2 border-solid border-red-600 text-red-600 shadow-sm p-2 rounded-md transition-all duration-300 hover:bg-red-600 hover:text-[#eee]'>
                    Configure Exam
                </Link>
            </div>
        </>
