                ...
                <section>
                    <div className='relative'>
                        ...
                        <div className='absolute top-[40%] left-10 max-w-[50rem]'>
                            <h1 className='font-mon font-800 text-[#fff] text-4xl mb-2'>Empowering Knowledge: <span className='text-red-900'>Seamless Exam Creation and Participation</span></h1>
                            <p className='text-[#000] text-base/relaxed font-500 leading-[1.6]'>
                    ...
                    <div className='grid grid-cols-2 py-5 px-4 gap-8 items-center'>
                        <img
                            src={aboutDescImg}
