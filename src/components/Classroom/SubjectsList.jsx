...
function SubjectsList() {
    ...
    return (
        <>
            <Loading2 text='Start studying' data='' isLoading={true} className={'font-mon font-500 mt-3 text-[#344CB7] text-2xl tracking-tight'} />
                        ...
                        return (
                            <figure key={subject.id} className='flex flex-col gap-5 border-b border-solid border-b-gray-200 pb-4'>
                                <div className='flex htmd:flex-col gap-5'>
                                    ...
                                    />
                                    <div>
                                        <Link to={`${subject.link}`} onClick={scrollTop} className='font-karla font-700 text-2xl hover:text-[#344CB7] hover:underline'>
                                            {subject.text}
                                        </Link>
                                ...
                                <div className='ahsm:flex ahsm:flex-col ahsm:gap-4'>
                                    <Link onClick={scrollTop} to={`${subject.link}`} className='border-2 border-solid border-[#344CB7] text-[#344CB7] shadow-sm p-3 rounded-md transition-all duration-300 hover:bg-[#344CB7] hover:text-[#eee] ahsm:text-center'>
                                        Study questions
                                    </Link>
                                    {/* <button className='ml-4 ahsm:ml-0 border-2 border-solid border-[#1F509A] text-[#1F509A] shadow-sm p-2 rounded-md transition-all duration-300 hover:bg-[#1F509A] hover:text-[#eee]'>
                                        Save for later
                                    </button> */}
                                </div>
                            </figure>
                ...
                <div className='border border-solid border-slate-400 h-fit ilg:max-w-[30rem]'>
                    ...
                    <div className='flex flex-col gap-3 py-2'>
                        <Link className='border-b border-solid border-b-slate-400 px-3 pb-1'>
                            <h1 className='text-base font-mon font-500 text-[#0A3981] hover:underline'>Practice for Your Upcoming Exams</h1>
                        ...
                        <Link className='border-b border-solid border-b-slate-400 px-3 pb-1'>
                            <h1 className='text-base font-mon font-500 text-[#0A3981] hover:underline'>JAMB Questions and Answers</h1>
                        ...
                        <Link className='border-b border-solid border-b-slate-400 px-3 pb-1'>
                            <h1 className='text-base font-mon font-500 text-[#0A3981] hover:underline'>Study  Questions and Answers</h1>
                        ...
                        <Link className=' px-3 pb-1'>
                            <h1 className='text-base font-mon font-500 text-[#0A3981] hover:underline'>Live exam</h1>
