...
function Faq() {
    ...
    const faqs = [
        { id: 1, title: 'What is Remote Proctoring?', desc: 'Remote Proctoring is a method of monitoring and supervising online exams, where a student is remotely monitored through audio and video technology to ensure the integrity of the examination process.' },
        { id: 2, title: 'How does Remote Proctoring works?', desc: 'Students log into a proctoring platform, which verifies their identity and monitors them throughout the exam using webcam and microphone. The software flags any suspicious behavior or unusual activities for further investigation.' },
        { id: 3, title: 'What are the benefits of proctored exams?', desc: 'Enhanced security, deterrence of cheating, fairness in evaluating student performance, convenience for both students and instructors.' },
        { id: 4, title: 'Can I take an online exam with remote proctoring on any device?', desc: 'Yes, you can typically take an online exam with remote proctoring on various devices, such as computers, laptops, tablets, and smartphones. However, check the specific requirements and guidelines from the exam provider or remote proctoring platform to ensure compatibility with your chosen device.' },
        { id: 5, title: 'Is it easy or difficult to cheat in a remote proctored online mode exam?', desc: 'Cheating in a remote proctored online exam is generally more difficult compared to traditional in-person exams. Remote proctoring employs various measures, such as live video monitoring, AI behavior analysis, screen recording, and secure browser integration, to deter and detect cheating attempts. While it is not impossible to cheat, the combination of these measures makes it challenging and significantly reduces the likelihood of successful cheating.' },
    ]
