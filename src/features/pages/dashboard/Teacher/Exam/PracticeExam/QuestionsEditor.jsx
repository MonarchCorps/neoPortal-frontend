        ...
        <>
            ...
            <div className='fixed top-4 left-1/2 -translate-x-1/2 bg-[#100e0e] text-[#fff] px-3 py-2 rounded-md shadow z-[10] flex items-center himd:flex-col'>
                ...
                <div className='mt-1'>
                    ...
                    &nbsp;
                    <button
                        className='bg-[#344CB7]  text-[#fff] px-3 py-[0.4rem] rounded-md font-mon font-600 text-sm'
            ...
            <div className='col-span-2 flex items-center gap-5 mb-3'>
                <div className='w-full flex items-center justify-between cfsm:flex-col cfsm:items-start cfsm:gap-2'>
                    <div className='flex items-center'>
                        <button className='bg-white shadow p-2 rounded-md scale-75 transition-all hover:scale-95'
                            onClick={() => {
                                scrollTop();
                                setStep(1)
                            }}
                        ...
                        <h1 className='font-mon text-slate-950 font-600 text-3xl esm:text-2xl'>Edit Details</h1>
                    </div>
                    <button
            ...
            <div className='flex gap-3 my-6 mb-8 esm:grid esm:grid-cols-2'>
                <div className='bg-gray-300 px-3 py-2 rounded-md'>{formData?.examType}</div>
                <div className='bg-gray-300 px-3 py-2 rounded-md'>{formData?.examYear}</div>
                <div className='bg-gray-300 px-3 py-2 rounded-md esm:col-span-2'>{formData?.subject}</div>
            </div>
            <div className='mt-7'>
                                ...
                                >
                                    <div className='flex items-center justify-between flex-wrap gap-2'>
                                        ...
                                        <div className='flex items-center justify-between gap-2'>
                                            ...
                                            {i + 1 !== 1 && (<button onClick={() => handleRemoveQuestion(i, question.key, questions, setQuestions)} className='text-red-700 p-3 bg-red-600 bg-opacity-15 border border-red-600 rounded-md transition-all duration-200 hover:bg-opacity-100 hover:text-[#eeeded]'>
                                                <FaRegTrashCan />
                                            </button>
                                            )}
                                                    ...
                                                    <div key={opt.key}>
                                                        <div className='flex items-center justify-between mb-2 flex-wrap gap-2'>
                                                            ...
                                                            <div className='flex items-center gap-4'>
                                                                ...
                                                                {opt.id !== 'A' && opt.id !== 'B' && (
                                                                    <button
                                                                        className='text-red-600 p-2 bg-red-800 bg-opacity-15 border border-red-600 rounded-md transition-all duration-200 hover:bg-opacity-100 hover:text-[#eeeded]'
